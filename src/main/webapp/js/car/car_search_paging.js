...
function initPage(blocks) {
    ...
    var divcontent = document.getElementById("search-result");

    divcontent.innerHTML="";
    console.log(constr);
    constr.forEach(function (one) {

        divcontent.appendChild(one);
    });
    ...
    createPager("pager-forward",str,blocks);
